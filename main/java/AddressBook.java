...
public class AddressBook {
    ...
    private boolean isContactExist(String name) {
        boolean existance;
        existance = contactList.stream().anyMatch(personElement -> personElement.getFirstName().equals(name) || personElement.getLastName().equals(name));
        return existance;
    }
    ...
    private Contacts getContact(String name) {
        Contacts foundContact = contactList.stream().filter(contact -> contact.getFirstName().equals(name) || contact.getLastName().equals(name)).findFirst().orElse(null);
        return foundContact;
    }
}
